% Introduccion a Octave - 2022 - FCAI-UNCuyo - MoCCAI
% 
% Trabajo Practico 4 - Ejercicio 2
% Movimiento de una partı́cula que tiene una trayectoria helicoidal en 3D
close all
clear all
...
%----------------------------------------------------------
% 1) Graficamos la trayectoria entre 0 y 3pi
figure(1);clf
...
%----------------------------------------------------------
% 2) Distancia entre P0=r(t) y el plano sin(t)*x+cos(t)*y+z=3*t
...
%----------------------------------------------------------
% 4) Calculo de la longitud de la trayectoria entre 0 y 3pi
